...
<form action="" method="post" class="column is-half">
    ...
    <input class="mt-3 input is-link" type="password" name="password_confirmation" placeholder="confirmer">
    ...
    <p class="mt-5"><input class="button is-link" type="submit" name="submit" value="envoyer"></p>
</form>
